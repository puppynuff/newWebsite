...
async function setupDirectories() {
    ...
    let BASE_SYTEM_DIR = new directory(true, "base_system");

    // Load the file system, into the file system?
    let FILE_SYSTEM_DIR = new directory(true, "file_system");
    ...
    let TERMINAL_DIR = new directory(true, "terminal");
    ...
    let PACKAGE_MANAGER_DIR = new directory(true, "package_manager");
